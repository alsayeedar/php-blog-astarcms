<?php
	...
	$post_view_query = "SELECT * FROM posts WHERE status = 'Active' ORDER BY id desc LIMIT {$offset}, {$limit}";
			...
			<div class="row">
				<div class="col-sm-8">
					...
					<?php
						...
						$post_page_query = mysqli_query($conn, "SELECT * FROM posts WHERE status = 'Active'");
