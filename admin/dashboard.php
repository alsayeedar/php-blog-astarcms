...
?>
            <div class="widget">
              ...
              <div class="widget-content">
                <a href="manage-posts.php" class="btn btn-dark">
                  <div>
                    <i class="fa fa-pencil-square-o fa-2x" aria-hidden="true">
                    </i>
                  </div>Add Post
                </a>
                <a href="pages.php" class="btn btn-dark">
                  <div>
                    <i class="fa fa-file fa-2x" aria-hidden="true">
                    </i>
                  </div>Add Page
                </a>
                <a href="categorys.php" class="btn btn-dark">
                  <div>
                ...
                <a href="site-setting.php" class="btn btn-dark">
                  <div>
                  ...
                  <div class="widget-content">
                    <table class="table table-striped dash-table">
                      <tr>
                        ...
                        <th>
                          <?php
echo "<font color='green'><b>" . mysqli_num_rows(mysqli_query($conn, "SELECT * FROM posts")) . "</b></font>";
?>
                        </th>
                      </tr>
                      <tr>
                        ...
                        <th>
                          <?php
echo "<font color='green'><b>" . mysqli_num_rows(mysqli_query($conn, "SELECT * FROM categorys")) . "</b></font>";
?>
                        </th>
                      </tr>
                      <tr>
                        ...
                        <th>
                          <?php
echo "<font color='green'><b>" . mysqli_num_rows(mysqli_query($conn, "SELECT * FROM comments")) . "</b></font>";
?>
                        </th>
                      </tr>
                      <tr>
                        ...
                        <th>
                          <?php
echo "<font color='green'><b>" . mysqli_num_rows(mysqli_query($conn, "SELECT * FROM pages")) . "</b></font>";
?>
                        </th>
                      </tr>
                      <tr>
                        ...
                        <th>
                          <?php
echo "<font color='green'><b>" . mysqli_num_rows(mysqli_query($conn, "SELECT * FROM user")) . "</b></font>";
?>
                        ...
                        <th><?php 
$result = mysqli_query($conn, 'SELECT SUM(views) AS views_sum FROM posts');
                ...
                <div class="widget">
                  ...
                  <div class="widget-content">
                    <table class="table table-striped">
                      <?php
$post_view_query = "SELECT * FROM posts WHERE status = 'Active' ORDER BY id desc LIMIT 0, 2";
