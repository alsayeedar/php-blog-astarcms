  ...
  if (isset($_POST['submit'])) {
    if (isset($_SESSION['loginsuccessuser'])) {
      ...
      if (empty($image['name'])) {
        ...
        $query = mysqli_query($conn, "INSERT INTO media (name, author) VALUES ('$img_name', '{$_SESSION['loginsuccessuseremail']}')");
        if ($image_move && $query) {
                ...
                <div class="widget">
                  ...
                  <div class="widget-content">
                    <div class="container">
                      <div class="row">
                        <?php
                        $image_query = mysqli_query($conn, "SELECT * FROM media WHERE author = '{$_SESSION['loginsuccessuseremail']}' ORDER BY id desc LIMIT {$offset}, {$limit}");
                      ...
                      <?php
                      $media_page_query = mysqli_query($conn, "SELECT * FROM media WHERE author = '{$_SESSION['loginsuccessuseremail']}' ORDER BY id desc");
