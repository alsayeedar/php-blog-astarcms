...
<head>
  <title><?php
          echo "Privacy &amp; Policy" . " - " . siteinfo('site_name');
          ?></title>
  <meta charset="utf-8">
    ...
    <div class="row">
      <div class="col-sm-8">
        <div class="blog-post hentry index-post">
          <?php
          $privacy_query = mysqli_query($conn, "SELECT * FROM pages WHERE id = 4 AND status = 'Active'");
          while ($privacy_query_row = mysqli_fetch_assoc($privacy_query)) {
            $title = $privacy_query_row['title'];
            $maintopic = $privacy_query_row['main_topic'];
          ?>
