...
<html lang="en">
<head>
  <title><?php echo "Advertise" . " - " . siteinfo('site_name'); ?></title>
  <meta charset="utf-8">
    ...
    <div class="row">
      <div class="col-sm-8">
        <div class="blog-post hentry index-post">
          <?php
          $advertise_query = mysqli_query($conn, "SELECT * FROM pages WHERE id = 3 AND status = 'Active'");
          while ($advertise_query_row = mysqli_fetch_assoc($advertise_query)) {
            $title = $advertise_query_row['title'];
            $maintopic = $advertise_query_row['main_topic'];
          ?>
