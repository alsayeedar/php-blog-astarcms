    ...
    <div class="row">
      <div class="col-sm-8">
        <div class="blog-post hentry index-post">
          <?php
          $about_us_query = mysqli_query($conn, "SELECT * FROM pages WHERE id = 1 AND status = 'Active'");
          while ($about_us_query_row = mysqli_fetch_assoc($about_us_query)) {
            $title = $about_us_query_row['title'];
            $maintopic = $about_us_query_row['main_topic'];
          ?>
